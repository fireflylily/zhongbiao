      ...
      // ========== 知识中心 ==========
      {
        ...
        children: [
          ...
          // 案例详情
          {
            path: "case/:id",
            name: "CaseDetail",
            component: () => __vitePreload(() => import("./CaseDetail-B5G5BdWP.js"), true ? __vite__mapDeps([46,1,2,11,12,44,13,25,18,47,6]) : void 0),
            meta: {
              title: "案例详情",
              icon: "bi-archive",
              parent: "Knowledge",
