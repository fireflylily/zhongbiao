import { d as defineComponent, r as ref, c as computed, A as ElMessage, D as watch, S as onMounted, T as onBeforeUnmount, e as createElementBlock, o as openBlock, U as normalizeClass, n as createBaseVNode, k as createBlock, t as toDisplayString, X as ElTag, w as withCtx, f as createVNode, p as createTextVNode, h as unref, ap as loading_default, ad as ElIcon, aS as full_screen_default, g as ElButton, aD as view_default, aE as download_default, l as createCommentVNode, aT as refresh_default, F as Fragment, V as renderList, ar as ElEmpty, aU as d_arrow_left_default, aV as d_arrow_right_default, aN as mergeProps, aI as mC, aK as nextTick } from "./vendor-_9UVkM6-.js";
/* empty css                                                                           */
    ...
    const editorOptions = computed(() => ({
      ...
      ai: {
        assistant: {
          ...
          // AI 消息处理回调（核心方法）
          onMessage: async (payload, content2) => {
            ...
            try {
              ...
              const response = await fetch("/api/editor/ai-assistant", {
                ...
                body: JSON.stringify({
                  command,
                  // AI 操作类型（如：rewrite, expand, summarize）
                  input,
                  // 用户选中的文本
                  output,
                  // 输出格式（HTML）
...
const RichTextEditor = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9ca8f464"]]);
export {
  RichTextEditor as R
};
